...
model_name = '/Users/nliberma/Documents/Thesis/experiment/noir_seq_gru_do_dynamic_B50/' + str(1) + '/model/model' + str(1)
...
for epoch in range(1):
	...
	for j in range(1, 64):
		...
		for i in range(len(list_seq)):
			...
			input = Variable(data_in, requires_grad=True) ### TRUE ???
